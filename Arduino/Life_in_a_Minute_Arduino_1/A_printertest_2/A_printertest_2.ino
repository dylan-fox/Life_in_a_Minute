...
void loop() {
  if (phase == 1) {
    testPrint(12.3);
    printReceipt(10.0, 11.2, 13.6, 18.1, 9.0, 5.6);
    phase +=1;
  }
}

void testPrint(float testNum) {
  printer.setDefault();
  printer.inverseOn();
  printer.println(F("Inverse ON"));
  printer.inverseOff();
   ...
   //Testnum
  printer.justify('L');
  printer.println(F("testNum"));
  printer.justify('R');
  printer.println(testNum); 
...
void printReceipt (float careerYears, float communityYears, float educationYears, float familyYears, float playYears, float wastedYears) {
  ...
  printer.justify('R');
  printer.println(communityYears);
  printer.println(F(""));
  ...
  printer.justify('R');
  printer.println(educationYears);
  printer.println(F(""));
  ...
  printer.justify('R');
  printer.println(playYears);
  printer.println(F(""));
  

  //Wasted
  printer.justify('L');
  printer.println(F("Wasted"));
  printer.justify('R');
  printer.println(wastedYears);
  printer.println(F(""));
